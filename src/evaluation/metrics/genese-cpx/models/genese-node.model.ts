...
//
// export class AstNodeGenese implements JsonAstNodeInterface, Evaluate, Logg {
//
...
//     lineStart?: number = undefined;                                            // The issue of the line containing the character at the AstNode.extractHooksAndArrowFunctions
//     name: string = undefined;                                                  // The name of the AstNode
//     parent?: AstNode;                                                          // The ast of the parent of the current node
//     pos ?= 0;                                                                  // The pos of the beginning of the AST node, including spaces and comments before it. (extractHooksAndArrowFunctions <= extractHooksAndArrowFunctions)
//     start ?= 0;                                                                // The pos of the beginning of the AST node, without spaces and comments before it. (extractHooksAndArrowFunctions >= extractHooksAndArrowFunctions)
//     text: string = undefined;                                                  // The code of the AstNode
//     type: string = undefined;                                          // The type of the AstNode (if given)
//
//
